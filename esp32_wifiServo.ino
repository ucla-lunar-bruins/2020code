      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            // LED buttons
            client.println("<button onclick=\"location.href='/U'\">UP</button>");
            client.println(" <button onclick=\"location.href='/L'\">LEFT</button><br>");
            client.print(" <button onclick=\"location.href='/R'\">RIGHT</button><br>");
            client.println(" <button onclick=\"location.href='/D'\">DOWN</button><br>");
            client.println(" <button onclick=\"location.href='/S'\">STOP</button><br>");
            //End LED buttons
...
/*
boolean endsWith(String inString, String compString) {
